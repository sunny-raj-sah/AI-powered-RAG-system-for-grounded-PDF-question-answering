 ...
 export default function BookQA() {
   ...
   const handleUpload = async () => {
     ...
     setUploadState({ status: "loading", message: "Reading pages and building chunks…" });
         ...
         <aside className="sidebar">
           ...
           <div style={{ marginBottom: 28 }}>
             <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
               ...
               <h2 className="sans" style={{ fontSize: 12.5, fontWeight: 600, margin: 0, color: "#C7CBD6" }}>
                 API key
               </h2>
               {keySaved && (
                 <span
                   className="sans"
                   style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 3, fontSize: 11, color: "#7FAE93" }}
                 >
                   <BookmarkCheck size={12} /> Saved
                 </span>
               )}
             </div>
             <p className="sans" style={{ fontSize: 11.5, color: "#7B8092", margin: "0 0 10px", lineHeight: 1.5 }}>
               Provide your OpenAI key to use OpenAI models.
Leave empty to use HuggingFace embeddings + Groq AI.
             </p>
           ...
           <div style={{ height: 1, background: "#232A3B", margin: "0 0 24px" }} />
           ...
           <div>
             ...
             >
               <input
                 ...
                 style={{ display: "none" }}
               />
               <FileText size={18} color={file ? "#C89B4A" : "#5C6273"} style={{ marginBottom: 6 }} />
               <div className="sans" style={{ fontSize: 12, color: "#C7CBD6", wordBreak: "break-word" }}>
             ...
             <button
               ...
               style={{
                 ...
                 fontWeight: 600,
                 fontSize: 12.5,
                 cursor: uploadState.status === "loading" ? "default" : "pointer",
             ...
             >
               ...
               {uploadState.status === "loading" ? "Uploading…" : "Upload & index"}
             </button>
         ...
         <main className="main">
           <div className="main-inner">
             <div style={{ marginBottom: 26 }}>
               <h2 style={{ fontSize: 28, fontWeight: 700, margin: "0 0 6px", letterSpacing: "-0.01em" }}>
                 Ask a question
               </h2>
               <p className="sans" style={{ margin: 0, fontSize: 14, color: "#9AA0AF" }}>
             ...
             {answer && (
               ...
               >
                 ...
                 <div
                   className="sans"
                   style={{ fontSize: 11.5, letterSpacing: "0.06em", color: "#8A7A4E", marginBottom: 10, textTransform: "uppercase" }}
                 >
                   Answer
                 </div>
                 <div style={{ fontSize: 16.5, lineHeight: 1.7, whiteSpace: "pre-wrap" }}>{answer}</div>
               </div>
             )}
 ...
 function StatusLine({ state }) {
   ...
   return (
     <span className="sans" style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12.5, color }}>
       <Icon size={14} />
       {state.message}
     </span>
   );
